...
"""autogenerated by genpy from nao_matador/SpeechWithFeedbackActionResult.msg. Do not edit."""
import codecs
import sys
...
class SpeechWithFeedbackActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "nao_matador/SpeechWithFeedbackActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nao_matador/SpeechWithFeedbackResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SpeechWithFeedbackActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = nao_matador.msg.SpeechWithFeedbackResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nao_matador.msg.SpeechWithFeedbackResult()

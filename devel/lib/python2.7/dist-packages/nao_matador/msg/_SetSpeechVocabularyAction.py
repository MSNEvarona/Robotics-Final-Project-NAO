...
"""autogenerated by genpy from nao_matador/SetSpeechVocabularyAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import nao_matador.msg
import std_msgs.msg

class SetSpeechVocabularyAction(genpy.Message):
  _md5sum = "737441a71b3375ccf5219f84239ade13"
  _type = "nao_matador/SetSpeechVocabularyAction"
...
"""
  ...
  _slot_types = ['nao_matador/SetSpeechVocabularyActionGoal','nao_matador/SetSpeechVocabularyActionResult','nao_matador/SetSpeechVocabularyActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetSpeechVocabularyAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = nao_matador.msg.SetSpeechVocabularyActionGoal()
      if self.action_result is None:
        self.action_result = nao_matador.msg.SetSpeechVocabularyActionResult()
      if self.action_feedback is None:
        self.action_feedback = nao_matador.msg.SetSpeechVocabularyActionFeedback()
    else:
      self.action_goal = nao_matador.msg.SetSpeechVocabularyActionGoal()
      self.action_result = nao_matador.msg.SetSpeechVocabularyActionResult()
      self.action_feedback = nao_matador.msg.SetSpeechVocabularyActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.words)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.words:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.words.append(val1)
      _x = self
      start = end
      end += 12

...
class SetSpeechVocabularyActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SetSpeechVocabularyFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetSpeechVocabularyActionFeedback(null);
    ...
    data.feedback = SetSpeechVocabularyFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetSpeechVocabularyActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SetSpeechVocabularyFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SetSpeechVocabularyFeedback()
    }
...
module.exports = SetSpeechVocabularyActionFeedback;

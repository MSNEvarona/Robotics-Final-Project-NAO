// Generated by gencpp from file nao_matador/BlinkGoal.msg
// DO NOT EDIT!


#ifndef NAO_MATADOR_MESSAGE_BLINKGOAL_H
#define NAO_MATADOR_MESSAGE_BLINKGOAL_H
...
struct BlinkGoal_
{
  ...
  typedef boost::shared_ptr< ::nao_matador::BlinkGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::nao_matador::BlinkGoal_<ContainerAllocator> const> ConstPtr;

}; // struct BlinkGoal_

typedef ::nao_matador::BlinkGoal_<std::allocator<void> > BlinkGoal;

typedef boost::shared_ptr< ::nao_matador::BlinkGoal > BlinkGoalPtr;
typedef boost::shared_ptr< ::nao_matador::BlinkGoal const> BlinkGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::nao_matador::BlinkGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nao_matador::BlinkGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nao_matador::BlinkGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nao_matador::BlinkGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_matador::BlinkGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nao_matador::BlinkGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_matador::BlinkGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nao_matador::BlinkGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nao_matador::BlinkGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nao_matador::BlinkGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5e5d3c2ba9976dc1ULL;
  static const uint64_t static_value2 = 0x21a0bb6ef7c66d79ULL;
};

template<class ContainerAllocator>
struct DataType< ::nao_matador::BlinkGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "nao_matador/BlinkGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::nao_matador::BlinkGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nao_matador::BlinkGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nao_matador::BlinkGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nao_matador::BlinkGoal_<ContainerAllocator>& v)
  {
...
#endif // NAO_MATADOR_MESSAGE_BLINKGOAL_H

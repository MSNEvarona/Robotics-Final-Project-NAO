...
class SpeechWithFeedbackActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SpeechWithFeedbackGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SpeechWithFeedbackActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = SpeechWithFeedbackGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SpeechWithFeedbackGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpeechWithFeedbackActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SpeechWithFeedbackGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SpeechWithFeedbackGoal()
    }
...
module.exports = SpeechWithFeedbackActionGoal;

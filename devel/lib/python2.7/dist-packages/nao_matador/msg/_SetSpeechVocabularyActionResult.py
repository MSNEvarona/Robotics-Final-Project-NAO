...
"""autogenerated by genpy from nao_matador/SetSpeechVocabularyActionResult.msg. Do not edit."""
import codecs
import sys
...
class SetSpeechVocabularyActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "nao_matador/SetSpeechVocabularyActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nao_matador/SetSpeechVocabularyResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetSpeechVocabularyActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = nao_matador.msg.SetSpeechVocabularyResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nao_matador.msg.SetSpeechVocabularyResult()

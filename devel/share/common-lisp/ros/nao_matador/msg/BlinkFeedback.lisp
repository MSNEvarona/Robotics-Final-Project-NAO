...
(cl:defmethod cl:initialize-instance :after ((m <BlinkFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BlinkFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_matador-msg:<BlinkFeedback> is deprecated: use nao_matador-msg:BlinkFeedback instead.")))

(cl:ensure-generic-function 'last_color-val :lambda-list '(m))
(cl:defmethod last_color-val ((m <BlinkFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_matador-msg:last_color-val is deprecated.  Use nao_matador-msg:last_color instead.")
  (last_color m))
